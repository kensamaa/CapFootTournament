...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20230212115932_AddMoreAttributeInTournament")]
    partial class AddMoreAttributeInTournament
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entites.Capgemini", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2b67b980-9925-4d32-a575-a52fd8f81936"),
                            City = "Casablanca",
                            Country = "Morocco",
                            DateCreated = new DateTime(2023, 2, 12, 12, 59, 31, 950, DateTimeKind.Local).AddTicks(1876),
                            DateCreation = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateModified = new DateTime(2023, 2, 12, 12, 59, 31, 950, DateTimeKind.Local).AddTicks(1934),
                            Name = "TS",
                            NumberOfTeams = 0
                        });
                });
